        ...
        <div class="form-ques">
          ...
          <div class="ques-action">
            ...
            <a-button class="action-btn">
              <router-link to="/inquiries">更多问题回答</router-link></a-button
            >
          </div>
        </div>
        <!-- 提问 -->
        <div class="form-ask-ques">
          <h3 class="mb-10 mt-10 cline-hint">在此输入您的回答</h3>
          <a-textarea class="mb-10" placeholder="在此输入您的回答" :rows="4" />
          <a-button class="mb-10 mr-10" type="primary">提交</a-button>
          <a-button class="mb-10" type="primary" @click="$router.back()"
            >返回</a-button
          >
        </div>
      </div>
